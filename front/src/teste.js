...
// Validação de CPF e CNPJ com Máscara em javascript
// cpf_cnpj_validate
...
// se for CPF
    if (tam == 11) {
        ...
        obj= maskCPF(s); // se validou o CPF mascaramos corretamente
        return true;
    }
...
// se for CNPJ
    if (tam == 14) {
        ...
        obj = maskCNPJ(s); // se validou o CNPJ mascaramos corretamente
        return true;
    }
}
